...
namespace Voyager.DBConnection.Interfaces
{
	...
	public interface IDbCommandExecutor
	{
		...
		/// <summary>
		/// Executes a command and processes the result set using a function that accepts an IDataReader.
		/// </summary>
		/// <typeparam name="TValue">The type of the result produced by the reader function.</typeparam>
		/// <param name="commandFactory">The factory that creates the database command.</param>
		/// <param name="readerFunc">Function that processes the data reader and returns the result.</param>
		/// <param name="afterCall">Optional callback invoked after successful execution with the command.</param>
		/// <returns>A result containing the processed value, or an error if the operation failed.</returns>
		Result<TValue> ExecuteReader<TValue>(IDbCommandFactory commandFactory, Func<IDataReader, TValue> readerFunc, Action<DbCommand> afterCall = null);

		/// <summary>
		/// Executes a command using a function and processes the result set using a function that accepts an IDataReader.
		/// </summary>
		/// <typeparam name="TValue">The type of the result produced by the reader function.</typeparam>
		/// <param name="commandFunction">Function that creates the database command using the database instance.</param>
		/// <param name="readerFunc">Function that processes the data reader and returns the result.</param>
		/// <param name="afterCall">Optional callback invoked after successful execution with the command.</param>
		/// <returns>A result containing the processed value, or an error if the operation failed.</returns>
		Result<TValue> ExecuteReader<TValue>(Func<IDatabase, DbCommand> commandFunction, Func<IDataReader, TValue> readerFunc, Action<DbCommand> afterCall = null);

		/// <summary>
		/// Executes a stored procedure and processes the result set using a function that accepts an IDataReader.
		/// </summary>
		/// <typeparam name="TValue">The type of the result produced by the reader function.</typeparam>
		/// <param name="procedureName">The name of the stored procedure to execute.</param>
		/// <param name="actionAddParams">Optional callback to add parameters to the command.</param>
		...
		/// <param name="afterCall">Optional callback invoked after successful execution with the command.</param>
		/// <returns>A result containing the processed value, or an error if the operation failed.</returns>
		Result<TValue> ExecuteReader<TValue>(string procedureName, Action<DbCommand> actionAddParams, Func<IDataReader, TValue> readerFunc, Action<DbCommand> afterCall = null);
		...
		/// <summary>
		/// Asynchronously executes a command and processes the result set using a function that accepts an IDataReader.
		/// </summary>
		/// <typeparam name="TValue">The type of the result produced by the reader function.</typeparam>
		/// <param name="commandFactory">The factory that creates the database command.</param>
		/// <param name="readerFunc">Function that processes the data reader and returns the result.</param>
		/// <param name="afterCall">Optional callback invoked after successful execution with the command.</param>
		/// <returns>A task representing the asynchronous operation with the result containing the processed value or an error.</returns>
		Task<Result<TValue>> ExecuteReaderAsync<TValue>(IDbCommandFactory commandFactory, Func<IDataReader, TValue> readerFunc, Action<DbCommand> afterCall = null);

		/// <summary>
		/// Asynchronously executes a command and processes the result set using a function that accepts an IDataReader with cancellation support.
		/// </summary>
		/// <typeparam name="TValue">The type of the result produced by the reader function.</typeparam>
		/// <param name="commandFactory">The factory that creates the database command.</param>
		/// <param name="readerFunc">Function that processes the data reader and returns the result.</param>
		...
		/// <param name="cancellationToken">A token to cancel the asynchronous operation.</param>
		/// <returns>A task representing the asynchronous operation with the result containing the processed value or an error.</returns>
		Task<Result<TValue>> ExecuteReaderAsync<TValue>(IDbCommandFactory commandFactory, Func<IDataReader, TValue> readerFunc, Action<DbCommand> afterCall, CancellationToken cancellationToken);

		/// <summary>
		/// Asynchronously executes a command using a function and processes the result set using a function that accepts an IDataReader.
		/// </summary>
		/// <typeparam name="TValue">The type of the result produced by the reader function.</typeparam>
		/// <param name="commandFunction">Function that creates the database command using the database instance.</param>
		/// <param name="readerFunc">Function that processes the data reader and returns the result.</param>
		/// <param name="afterCall">Optional callback invoked after successful execution with the command.</param>
		/// <returns>A task representing the asynchronous operation with the result containing the processed value or an error.</returns>
		Task<Result<TValue>> ExecuteReaderAsync<TValue>(Func<IDatabase, DbCommand> commandFunction, Func<IDataReader, TValue> readerFunc, Action<DbCommand> afterCall = null);

		/// <summary>
		/// Asynchronously executes a command using a function and processes the result set using a function that accepts an IDataReader with cancellation support.
		/// </summary>
		/// <typeparam name="TValue">The type of the result produced by the reader function.</typeparam>
		/// <param name="commandFunction">Function that creates the database command using the database instance.</param>
		/// <param name="readerFunc">Function that processes the data reader and returns the result.</param>
		...
		/// <param name="cancellationToken">A token to cancel the asynchronous operation.</param>
		/// <returns>A task representing the asynchronous operation with the result containing the processed value or an error.</returns>
		Task<Result<TValue>> ExecuteReaderAsync<TValue>(Func<IDatabase, DbCommand> commandFunction, Func<IDataReader, TValue> readerFunc, Action<DbCommand> afterCall, CancellationToken cancellationToken);

		/// <summary>
		/// Asynchronously executes a stored procedure and processes the result set using a function that accepts an IDataReader.
		/// </summary>
		/// <typeparam name="TValue">The type of the result produced by the reader function.</typeparam>
		/// <param name="procedureName">The name of the stored procedure to execute.</param>
		/// <param name="actionAddParams">Optional callback to add parameters to the command.</param>
		...
		/// <param name="afterCall">Optional callback invoked after successful execution with the command.</param>
		/// <returns>A task representing the asynchronous operation with the result containing the processed value or an error.</returns>
		Task<Result<TValue>> ExecuteReaderAsync<TValue>(string procedureName, Action<DbCommand> actionAddParams, Func<IDataReader, TValue> readerFunc, Action<DbCommand> afterCall = null);

		/// <summary>
		/// Asynchronously executes a stored procedure and processes the result set using a function that accepts an IDataReader with cancellation support.
		/// </summary>
		/// <typeparam name="TValue">The type of the result produced by the reader function.</typeparam>
		/// <param name="procedureName">The name of the stored procedure to execute.</param>
		/// <param name="actionAddParams">Optional callback to add parameters to the command.</param>
		...
		/// <param name="cancellationToken">A token to cancel the asynchronous operation.</param>
		/// <returns>A task representing the asynchronous operation with the result containing the processed value or an error.</returns>
		Task<Result<TValue>> ExecuteReaderAsync<TValue>(string procedureName, Action<DbCommand> actionAddParams, Func<IDataReader, TValue> readerFunc, Action<DbCommand> afterCall, CancellationToken cancellationToken);
